...
const string strMessageMagic = "maxocoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 2)
  {
    nSubsidy = 120000000 * COIN;
  }
    else if(pindexBest->nHeight+1 >= 11 && pindexBest->nHeight+1 <= 120000000)
  {
    nSubsidy = 0 * COIN;
  }
...
// maxocoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "maxocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "MXC MaxoCoin MXC";
        CTransaction txNew;
        txNew.nTime = 1492849379;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x44cc3c9c4bc0e613f61f2e75d600b88d466142331e2ec110fd3a8487c8c64732"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf2, 0x1d, 0xa6, 0xf1 };
